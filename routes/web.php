...
Route::post('/reservations/{car_id}/store', [ReservationController::class, 'store'])->name('reservation.store');
...
//Route::get('/reservations', [ReservationController::class, 'index'])->name('clientReservation')->middleware('auth');

//Route::get('/reservations/{reservation}', [ReservationController::class, 'show'])->name('client.reservation.show');
Route::delete('/reservations/{reservation}', [ReservationController::class, 'destroy'])->name('client.reservation.destroy');
